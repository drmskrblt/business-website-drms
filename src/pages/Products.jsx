...
const Products = () => {
  return (
    <>
      <section className="bg-primary-bg w-full p-6 text-white">
          ...
          <div className="grid gap-8 grid-cols-1 mt-10 md:grid-cols-3">
            {webdesignPricing.map((item, index) => {
              return (
                <div key={index}>
                  {/* Card Container */}
                  <div className="p-8 border-2 border-gray-200 rounded-xl bg-secondary-bg shadow-lg flex flex-col">
                    <h3 className="text-white text-lg font-semibold mb-1 text-center">
                      {/* Card Heading */}
                      {item.heading}
                    </h3>
                    <p className="flex items-baseline justify-center text-white mb-4">
      ...
      <section className="bg-primary-bg h-full p-4">
        {/* Ueberschrift Produkte */}
        <div className="text-center text-white p-4">
